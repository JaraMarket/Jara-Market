...
Route::get('/fetchUserProfile/{email}', [UserController::class, 'fetchUserProfile']);
Route::post('/edit-user-profile/{email}', [UserController::class, 'editUserProfile']);
...
Route::get('/fetch-ingredient', [ProductController::class, 'fetchingredient']);
