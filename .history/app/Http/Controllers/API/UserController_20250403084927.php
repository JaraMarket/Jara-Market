...
class CustomerController extends Controller
{
     ...
     *     description="Register a new customer with optional referral code",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     ...
     *             @OA\Property(property="referral_code", type="string", example="1234")
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="message", type="string", example="An OTP has been sent to your email address. It expires after 15 minutes."),
     ...
     *     @OA\Response(
     *         response=400,
     *         description="Invalid referral code or validation error"
     *     )
     * )
     */
    ...
    /**
     * @OA\Post(
     *     path="/api/customer/validate-register-otp",
     *     tags={"Customers"},
     *     summary="Validate registration OTP",
     *     description="Validate the OTP sent during registration",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"otp", "customer_id"},
     *             @OA\Property(property="otp", type="string", example="1234"),
     *             @OA\Property(property="customer_id", type="string", format="email", example="john@example.com")
     *         )
     *     ),
     *     @OA\Response(
     *         response=201,
     ...
     *             @OA\Property(property="message", type="string", example="OTP validated successfully and registration Complete"),
     *             @OA\Property(property="token", type="string")
     *         )
     *     ),
     *     @OA\Response(
     ...
     *     @OA\Response(
     *         response=201,
     *         description="Login credentials validated, OTP sent",
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="An OTP has been sent to your email address. OTP expires after 15 minutes."),
     *             @OA\Property(property="data", type="object")
     *         )
     *     ),
     *     @OA\Response(
    ...
    /**
     * @OA\Post(
     *     path="/api/customer/validate-login-otp",
     *     tags={"Customers"},
     *     summary="Validate login OTP",
     *     description="Validate the OTP sent during login",
     *     @OA\RequestBody(
     *         required=true,
     *         @OA\JsonContent(
     *             required={"otp", "email"},
     ...
     *         @OA\JsonContent(
     *             @OA\Property(property="success", type="boolean", example=true),
     *             @OA\Property(property="message", type="string", example="OTP validated successfully and login complete"),
     *             @OA\Property(property="token", type="string"),
     *             @OA\Property(property="data", type="object")
     *         )
     *     ),
