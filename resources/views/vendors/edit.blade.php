                    ...
                    <form action="{{ route('vendors.update', $vendor) }}" method="POST">
                        ...
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="business_name" id="business_name" value="{{ old('business_name', $vendor->business_name) }}"
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="business_registration_number" id="business_registration_number" value="{{ old('business_registration_number', $vendor->business_registration_number) }}"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="business_address" id="business_address" rows="3"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('business_address', $vendor->business_address) }}</textarea>
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="business_phone" id="business_phone" value="{{ old('business_phone', $vendor->business_phone) }}"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="email" name="business_email" id="business_email" value="{{ old('business_email', $vendor->business_email) }}"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-6">
                                ...
                                <textarea name="business_description" id="business_description" rows="3"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">{{ old('business_description', $vendor->business_description) }}</textarea>
