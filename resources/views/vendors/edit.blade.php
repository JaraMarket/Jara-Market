    ...
    <div class="py-4">
        ...
        <div class="bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                ...
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Update vendor information and settings.</p>
            </div>
            <div class="border-t border-gray-200">
                <form action="{{ route('vendors.update', $user) }}" method="POST" class="divide-y divide-gray-200">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="px-4 py-5 sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            ...
                            <div class="col-span-6 sm:col-span-3">
                                <label for="business_address" class="block text-sm font-medium text-gray-700">Business Name</label>
                                <input type="text" name="business_address" id="business_address" value="{{ old('business_address', $user->business_address) }}"
                                    class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
                            ...
                            <div class="col-span-4 sm:col-span-3">
                                ...
                                <select id="is_active" name="is_active"
                                    ...
                                    <option value="1" {{ old('active', $user->is_active) ? 'selected' : '' }}>Active
                                    </option>
                                    <option value="0" {{ old('active', $user->is_active) ? '' : 'selected' }}>Inactive
                                    </option>
                                </select>
                                @error('is_active')
                                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
        ...
        <div class="mt-8 bg-white shadow overflow-hidden sm:rounded-lg">
            <div class="px-4 py-5 sm:px-6">
                <h3 class="text-lg leading-6 font-medium text-gray-900">Vendor's Orders</h3>
                <p class="mt-1 max-w-2xl text-sm text-gray-500">Order history for this vendor.</p>
            </div>
                    ...
                    <thead class="bg-gray-50">
                        <tr>
                            <th scope="col"
                                ...
                                ID</th>
                            <th scope="col"
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Reference
                                </th>
                            <th scope="col"
                                class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Order Date
                            </th>
                            <th scope="col"
